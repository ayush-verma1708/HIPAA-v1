...
import discoveredAssetsAndScopeRoutes from './routes/discoveredAssetsAndScopeRoutes.js';
...
// discoveredAssetAndScopes
app.use('/api', discoveredAssetsAndScopeRoutes); // Use asset and scope routes under `/api`
